...
import { LayoutDashboard, Package, Users, Settings, Wrench, Calendar, LogOut, Search, Bell } from "lucide-react";
...
export default function AdminLayout({
    ...
    return (
        <div className="flex min-h-screen bg-[#050505] text-slate-200 font-sans selection:bg-purple-500/30">
            {/* Sidebar */}
            <aside className="fixed left-0 top-0 bottom-0 w-64 border-r border-white/5 bg-[#0a0a0a]/50 backdrop-blur-xl z-50 flex flex-col">
